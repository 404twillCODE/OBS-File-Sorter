# OBS File Sorter — Website

Landing page for [OBS File Sorter](https://github.com/404twillCODE/OBS-File-Sorter), built with Next.js (static export) and Tailwind. Design matches FocusedOnTom.

- **Local dev:** `npm install` then `npm run dev` (no basePath in dev).
